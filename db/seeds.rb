...
Interest.create!(name: "Book Clubs")
Interest.create!(name: "Cultural Celebrations")
Interest.create!(name: "Charity Drives")
Interest.create!(name: "Cooking")
Interest.create!(name: "Education")
Interest.create!(name: "Fund-raising Events")
Interest.create!(name: "Gardening")
Interest.create!(name: "Technology")
Interest.create!(name: "Music")
Interest.create!(name: "Sports & Wellness")
Interest.create!(name: "SG Heritage Tours")
Interest.create!(name: "Social Clubs")
Interest.create!(name: "Professional Development")
